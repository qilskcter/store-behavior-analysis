...
class YoloDetect():
    def __init__(self, detect_class="person", frame_width=1280, frame_height=720):
        ...
        self.weights_file = "./dnn_model/yolov4-tiny.weights"
        self.config_file = "./dnn_model/yolov4-tiny.cfg"
        ...
        self.scale = 1 / 255
        self.model = cv2.dnn.readNet(self.config_file, self.weights_file)
        self.classes = None
    ...
    def alert(self, img):
        ...
        if (self.last_alert is None) or (
            ...
            cv2.imwrite("data/alert.png", img)
